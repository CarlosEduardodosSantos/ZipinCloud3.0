...
export class ProdutoCreateComponent implements OnInit {
  ...
  async onSubmit(data: any) {
    ...
    if (data.codigo == "" || data.deS_ == "" || data.vlvenda == "" ||
        data.qtdE1 == "" || data.grupo == "" || data.tipo == "" || data.vlcusto == "") {
